import { Calendar, CheckCircle, Eye, EyeOff, Hash, MapPin, Phone, User } from "lucide-react";
import type { ParsedDataComponentProps } from "../../Types/parsed-data.types";
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <p className="text-gray-900 font-mono">
                  {showAadhaarNumber ? extractedData.aadhaarNumber : '••••  ••••  ••••'}
                </p>
                <button
                  onClick={onToggleAadhaarVisibility}
